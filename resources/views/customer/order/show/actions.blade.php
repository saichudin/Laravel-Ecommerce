<div class="card">
    <div class="card-block">
        @can('edit orders')
            <div class="dropdown float-left">
                ...
                <div class="dropdown-menu">
                    ...
                    {!! Form::model($order, [
                        'route'  => ['customer.order.update', $order],
                        'method' => 'PUT',
        ...
        @can('delete orders')
            {!! Form::open(['route' => ['customer.order.destroy', $order], 'method' => 'DELETE', 'class' => "float-right"]) !!}
            <button class="btn btn-outline-danger" onclick="return confirm('Are you sure you ?');">
                {{ __('Delete order') }}
            </button>
            {!! Form::close() !!}
        @endcan
